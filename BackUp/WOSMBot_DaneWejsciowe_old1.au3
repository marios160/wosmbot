...
$okienko = GUICreate("Wprowadź potrzebne dane", 392, 198, -1011, 155)
...
$fldSerwer = GUICtrlCreateInput("XERO\INSERTGT", 184, 8, 193, 21)
...
$fldPodmiot = GUICtrlCreateInput("ARCTUS_2011", 184, 80, 193, 21)
