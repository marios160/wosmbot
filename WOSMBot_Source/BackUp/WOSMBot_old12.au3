...
$WOSMBot = GUICreate("Bot do wywoływania/odkładania skutków magazynowych", 663, 537, -1, -1)
...
$dataOd = GUICtrlCreateDate("2019/02/21 17:31:25", 48, 104, 162, 21)
GUICtrlSetOnEvent($dataOd, "dataOdChange")
$dataDo = GUICtrlCreateDate("2019/02/21 17:31:25", 48, 136, 162, 21)
...
GUICtrlSetFont($chckZaznaczWszystkie, 8, 800, 0, "MS Sans Serif")
GUICtrlSetOnEvent($chckZaznaczWszystkie, "chckZaznaczWszystkieClick")
...
GUICtrlCreateGroup("", -99, -99, 1, 1)
$lstKolejnosc = GUICtrlCreateList("", 310, 32, 340, 461, BitOR($GUI_SS_DEFAULT_LIST,$WS_HSCROLL))
...
$cmbMagazyn = GUICtrlCreateCombo("", 15, 208, 201, 25, BitOR($CBS_DROPDOWN,$CBS_AUTOHSCROLL))
GUICtrlSetOnEvent($cmbMagazyn, "cmbMagazynChange")
GUICtrlCreateGroup("", -99, -99, 1, 1)
$btnStart = GUICtrlCreateButton("Start", 8, 504, 75, 25)
GUICtrlSetFont($btnStart, 8, 800, 0, "MS Sans Serif")
