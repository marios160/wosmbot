...
Func logs($text)
	ConsoleWrite('@@ (262) :(' & @MIN & ':' & @SEC & ') logs()' & @CR) ;### Function Trace
	dodajLog($text)
...
Func zamknij()
	ConsoleWrite('@@ (408) :(' & @MIN & ':' & @SEC & ') zamknij()' & @CR) ;### Function Trace
	Exit
EndFunc   ;==>zamknij
...
Func pauza()
	ConsoleWrite('@@ (415) :(' & @MIN & ':' & @SEC & ') pauza()' & @CR) ;### Function Trace
...
EndFunc   ;==>pauza
Func pauzaLoop()
	ConsoleWrite('@@ (427) :(' & @MIN & ':' & @SEC & ') pauzaLoop()' & @CR) ;### Function Trace
	While $_PAUSE
		Sleep(1000)
	WEnd
EndFunc   ;==>pauzaLoop
Func pauzaSzybka()
	ConsoleWrite('@@ (433) :(' & @MIN & ':' & @SEC & ') pauzaSzybka()' & @CR) ;### Function Trace
	If $_PAUSE = False Then
		$_PAUSE = True
		logs("PAUZA........." & @LF)
		pauzaLoop()
...
Func wyslijSms($tresc)
	ConsoleWrite('@@ (450) :(' & @MIN & ':' & @SEC & ') wyslijSms()' & @CR) ;### Function Trace
	Run('SmsEagle.exe "' & $tresc & '"', "", @SW_HIDE)
EndFunc   ;==>wyslijSms

;---------------------------------------------------------------------------------------------------------------------
Func sprawdzDate($data)
	ConsoleWrite('@@ (456) :(' & @MIN & ':' & @SEC & ') sprawdzDate()' & @CR) ;### Function Trace
