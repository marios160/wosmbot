...
$dataOd = GUICtrlCreateDate("2018/09/21 10:10:35", 48, 104, 162, 21, $DTS_SHORTDATEFORMAT) ;08-11
GUICtrlSetOnEvent($dataOd, "dataOdChange")
$dataDo = GUICtrlCreateDate("2018/07/29 10:10:39", 48, 136, 162, 21, $DTS_SHORTDATEFORMAT)
